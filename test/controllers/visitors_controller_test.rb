...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { accommodation: @visitor.accommodation, finish_date: @visitor.finish_date, person_id: @visitor.person_id, start_date: @visitor.start_date } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { accommodation: @visitor.accommodation, finish_date: @visitor.finish_date, person_id: @visitor.person_id, start_date: @visitor.start_date } }
