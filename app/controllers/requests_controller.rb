class RequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @request.save
        format.html { redirect_to @request, notice: 'Успешно добавлено' }
  ...
  def update
    respond_to do |format|
      if @request.update(request_params)
        format.html { redirect_to @request, notice: 'Успешно отредактировано' }
  ...
  def destroy
    @request.destroy
    respond_to do |format|
      format.html { redirect_to requests_url, notice: 'Успешно удалено' }
